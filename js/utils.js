...
function respecBuyables(layer) {
	...
	if (!player[layer].noRespecConfirm && !confirm(tmp[layer].buyables.respecMessage || "你确定要重置吗？这也会强制你进行一次“" + (tmp[layer].name ? tmp[layer].name : layer) + "”重置！")) return
